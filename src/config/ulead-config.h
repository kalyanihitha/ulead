/* src/config/ulead-config.h.  Generated from ulead-config.h.in by configure.  */
/* src/config/ulead-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef ULEAD_CONFIG_H

#define ULEAD_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.ulead.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "ULead Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "ULead Core 1.5.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "ulead"
